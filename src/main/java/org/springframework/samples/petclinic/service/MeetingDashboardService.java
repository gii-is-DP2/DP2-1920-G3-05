...
public class MeetingDashboardService {
	...
	public MeetingDashboard getMeetingDashboard() throws DataAccessException{
		Object[] meetingAssisByGenre = this.meetAssisRepository.assistantByGenre();
		...
		Object[] meetByDay = this.meetRepository.meetingsByDay();
		for (Object object : meetByDay) {
			Object[] obj = (Object[]) object;
			int i = (int) obj[0];
			days[i-1] = obj;
		}
		Object[] assistantByMeeting = this.meetAssisRepository.assistantByMeeting();
		Integer meetingAssistant = this.meetAssisRepository.numberOfMeetingsAssistant();
		Integer numMeeting = this.meetRepository.numberOfMeetings();
		Double userAss = (double) (this.meetAssisRepository.usersAssisted().size()*100/this.userRepository.numberUser());
