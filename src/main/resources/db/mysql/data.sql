...
INSERT INTO news(id, name, head, fecha, body, redactor, tags, img) VALUES (1, 'Noticia 1', 'Harry potter vuelve', '2013-01-01','increible pero cierto','Jhon Doe','#impresionant','https://static4.abc.es/media/cultura/2018/09/05/Portada-Tu-no-mataras-Julia-navarro-kjVH-U301327176608Z9B-220x330@abc.jpg' );
INSERT INTO news(id, name, head, fecha, body, redactor, tags, img) VALUES (2, 'Noticia 2', 'Rafel Nadal publica un nuevo libro', '2015-03-03','Rafel Nadal, que no Rafael Nadal, nos vuelve a impresionar','Jhon Doe','#amazing#new','https://static4.abc.es/media/cultura/2018/09/05/Portada-Tu-no-mataras-Julia-navarro-kjVH-U301327176608Z9B-220x330@abc.jpg' );
INSERT INTO news(id, name, head, fecha, body, redactor, tags, img) VALUES (3, 'Noticia 3', 'IT resurge tras su llegada al cine', '2015-03-03','El final un poco defraudante','Jhon Doe','#cinema#fear','https://static4.abc.es/media/cultura/2018/09/05/Portada-Tu-no-mataras-Julia-navarro-kjVH-U301327176608Z9B-220x330@abc.jpg' );
