...
class TwoScenarios extends Simulation {
	...
	val csvFeeder = csv("CreateMeetingStressFeeder.csv").circular
	...
	setUp(scn1.inject(rampUsers(10000) during (10 seconds)),
		  scn2.inject(rampUsers(10000) during (10  seconds)))
