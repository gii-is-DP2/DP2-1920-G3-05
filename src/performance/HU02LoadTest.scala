...
class HU02LoadTest extends Simulation {
	...
	object EditBookWell {
		...
		.exec(http("editBookWell")
			...
			.formParam("image", "https://imagessl9.casadellibro.com/a/l/t5/79/9788498382679.jpg")
	...
	setUp(
		positiveScn.inject(rampUsers(30) during (100 seconds)),
		negativeScn.inject(rampUsers(30) during (100 seconds))
