...
class HU20StressTest extends Simulation {
	...
	setUp(positiveScn.inject(rampUsers(15000) during (10 seconds)),negativeScn.inject(rampUsers(15000) during (10 seconds))) 
