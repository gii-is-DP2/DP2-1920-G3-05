...
class PublicationLoadTest extends Simulation {
	...
	setUp(EditPublicationScenario.inject(rampUsers(1300) during (100 seconds)),
			WritePublicationScenario.inject(rampUsers(1300) during (100 seconds)))
