...
class HU09StressTest extends Simulation {
	...
	setUp(InscribeGoodMeetingScenario.inject(rampUsers(5000) during (10 seconds)),
			InscribeBadMeetingScenario.inject(rampUsers(5000) during (10 seconds)))
