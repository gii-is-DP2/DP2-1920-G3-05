...
class HU14LoadTest extends Simulation {
	...
	setUp(AddGoodBookScenario.inject(rampUsers(37) during (100 seconds)),
			AddBadBookScenario.inject(rampUsers(37) during (100 seconds)))
