...
class HU15LoadTest extends Simulation {
	...
	setUp(ReviewNewsScenario.inject(rampUsers(3800) during (100 seconds)),
			NoReviewNewsScenario.inject(rampUsers(3800) during (100 seconds)))
