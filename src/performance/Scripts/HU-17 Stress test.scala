...
class HU17StressTest extends Simulation {
	...
	setUp(scn.inject(rampUsers(55000) during (10 seconds))).protocols(httpProtocol) //escenario negativo con 85000 y positivo con 55000
}