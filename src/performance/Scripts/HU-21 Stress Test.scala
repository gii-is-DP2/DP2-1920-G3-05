...
class HU21StressTest extends Simulation {
	...
	val userData = csv("createUserStress.csv").queue
	...
	setUp(createUser.inject(rampUsers(6000) during(10 seconds)),updateUser.inject(rampUsers(6000) during(10 seconds)))
